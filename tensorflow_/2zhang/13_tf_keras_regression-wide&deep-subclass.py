...
#############################keras子类API wide&deep###########################################
# 搭建模型
class WideDeepModel(keras.models.Model): # 继承父类
    def __init__(self):
        super(WideDeepModel, self).__init__() # 父类初始化函数
        """定义模型的层次"""
